...
let gpt_configuration = new Configuration({
	apiKey: "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",
});
...
function genPromp(l){
  ...
  return `Imagine e descreva, em ingles, a aparência, com no máximo 250 caracteres, uma logo para uma ${l[0]} que ${l[1]}, ${l[2]} contendo tanto ${l[3]} quanto as cor/cores ${l[4]}. Descreva apenas a imagem em inglês, sem mencionar textos`
}
